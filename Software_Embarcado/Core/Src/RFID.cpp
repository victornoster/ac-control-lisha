...
RFID::StatusCode RFID::RFID_Select(	Uid *uid,			///< Pointer to Uid struct. Normally output, but can also be used to supply a known UID.
	...
	//		uint8_t 0: SEL 				Indicates the Cascade Level: RFID_CMD_SEL_CL1, RFID_CMD_SEL_CL2 or RFID_CMD_SEL_CL3
	...
	//		uint8_t 4: UID-data
	//		uint8_t 5: UID-data
	//		uint8_t 6: BCC					Block Check uint8_tacter - XOR of uint8_ts 2-5
	//		uint8_t 7: CRC_A
	//		uint8_t 8: CRC_A
